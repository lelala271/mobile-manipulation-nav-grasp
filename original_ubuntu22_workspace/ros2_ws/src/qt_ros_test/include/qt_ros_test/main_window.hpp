...
private slots:
    ...
    void on_pushButton_kcf_clicked(bool checked);

    void on_pushButton_orb_clicked(bool checked);

    void on_pushButton_rrt_clicked(bool checked);

    void on_pushButton_path1_clicked(bool checked);

    void on_pushButton_path2_clicked(bool checked);

    void on_pushButton_tts_clicked(bool checked);

    void on_pushButton_mic_clicked(bool checked);

    void on_pushButton_gu1_clicked(bool checked);

    void on_pushButton_gu2_clicked(bool checked);

    void on_pushButton_gu3_clicked(bool checked);

    void on_pushButton_ar1_clicked(bool checked);

    void on_pushButton_ar2_clicked(bool checked);
